<a href="{full-link}" class="swiper-slide slider-item poster-short poster-link--hover">
	[xfgiven_skoro]
	...
	<div class="poster-short_content">
		<div class="poster-short_content-wrapper">
            [xfgiven_age]<div class="poster-short_age-limit">[xfvalue_age]+</div>[/xfgiven_age]
			<div class="poster-short_image poster-short_image--wrapper">
				<img src="[xfvalue_poster]" class="swiper-lazy swiper-lazy-loaded" alt="{title}" title="{title}" lazy="loaded">
			</div>
		</div>
		<div class="poster-short_padding">
			<p class="poster-short_title">{title}</p>
			<p class="poster-short_extra">
                [rating-type-1]
				<span class="poster-short_rating">
				    <svg viewBox="0 0 22 20" fill="none" xmlns="http://www.w3.org/2000/svg" width="16" height="16" class="poster-short_icon-star">
                ...
                [/rating-type-1]
				<span class="poster-short_genre">[xfvalue_video_type]</span>
			</p>
            [ifxfvalue status-seriala="coming-out"]
			<div class="poster-label poster-label_status">
				<span class="poster-label_text">Выходит</span>
			</div>
			[/ifxfvalue]
			[ifxfvalue status-seriala="closed"]
			<div class="poster-label poster-label_status-red">
				<span class="poster-label_text">Закончен</span>
			</div>
			[/ifxfvalue]
		</div>
    </div>
